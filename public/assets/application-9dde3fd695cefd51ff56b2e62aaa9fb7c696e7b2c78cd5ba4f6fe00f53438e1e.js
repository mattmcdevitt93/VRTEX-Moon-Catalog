...
Module.bindings = function () {
	...
	// $("#moon_Region_id").change(function() {
	// 	console.log( "Update Constelation: " + $("#moon_Region_id").val() );
	// 	Module.getConsetllationsByID($("#moon_Region_id").val());
	// 	Module.hideSelectFields();
	// });

	// $("#moon_Constellation_id").change(function() {
	// 	console.log( "Update System: " + $("#moon_Constellation_id").val() );
	// 	Module.getSystemByID($("#moon_Constellation_id").val());
	// 	Module.hideSelectFields();
	// });

	// $("#moon_System_id").change(function() {
	// 	console.log( "Update Planet: " + $("#moon_System_id").val() );
	// 	Module.getPlanetByID($("#moon_System_id").val());
	// 	Module.hideSelectFields();
	// });

	// $("#moon_Planet_id").change(function() {
	// 	console.log( "Update Planet: " + $("#moon_Planet_id").val() );
	// 	Module.getMoonbyID($("#moon_System_id").val(), $("#moon_Planet_id").find('option:selected').attr("name") );
	// 	Module.hideSelectFields();
	// });

	// $("#moon_Moon_id").change(function() {
	// 	Module.hideSelectFields();
	// });
	...
	// 	var slider = $( "#" + i );
	// 	Module.sliderBindings(slider, handle);
	...
	// 		// Module.contentUpdate(ui.value, 0);
	// 	}
	// } );
